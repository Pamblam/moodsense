...
<html lang="en">
  ...
  <body>
	...
	<div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center">
		...
		<div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
			<h5 class="display-4 fw-bold lh-1">Written for Tadhack!</h5>
			<p class="lead">Written by Rob and Pam for TadHacks... </p>
			<p>Check out the repo on <a href='https://github.com/Pamblam/moodsense'><i class="fa-brands fa-github"></i> Github!</a></a>
		</div>
	</div>
